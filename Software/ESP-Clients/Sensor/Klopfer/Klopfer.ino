 ...
 */
 void onLongPressStop(){
  ...
  String payload = "{\"identifier\":\"data\",\"clickEvent\":\"onLongPressStop\"}";
  char payloadArray[200];
  payload.toCharArray(payloadArray, 200);
