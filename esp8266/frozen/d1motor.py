...
class Motor:
    ...
    def frequency(self, frequency=None):
        ...
        # Teil hinter dem | war self.index. Aber self.index = 1 zerstört das Setzen der Geschwindigkeit
        # Deswegen wurde aus self.index -> 0
        self.i2c.writeto_mem(self.address, 0x00 | 0,
